...
public class Crystal extends Block{
    ...
    public Crystal(ResourseManager resourseManager, Vector2 startPosition) {
        ...
        texture = resourseManager.getTexture(ResourseManager.crystal);
        stateTime = 0;
    }
    ...
    public void collection(UiInventory uiInventory) {
        uiInventory.ChangeInventoryPlus(2);
    }
