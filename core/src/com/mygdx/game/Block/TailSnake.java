...
public class TailSnake extends Block{
    private ResourseManager resourseManager;
    public static final Vector2 Size = new Vector2(40, 70);
    private Texture texture;

    public TailSnake(ResourseManager resourseManager, Vector2 startPosition) {
        ...
        texture = resourseManager.getTexture(ResourseManager.tailSnake);
        stateTime = 0;
        blockdamage = 1;
    }
